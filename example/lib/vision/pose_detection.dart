    ...
    return Scaffold(
      body: Stack(
        children: [
            ...
            overlay: Consumer<LearningPoseDetectionState>(
              builder: (_, state, __) {
                ...
                PoseLandmark? leftPinky =
                    state.data!.landmark(PoseLandmarkType.LEFT_INDEX);
                if (leftPinky!=null) {
                  ...
                  // print("dxxxxxxxxxxxxxxxxxxxxxxxxxxxxxyyyyyyyyyyyyyyyyyyyyyyyyy"+dy.toString());
                  // print("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"+dx.toString());
                  // print("00000000000000000000000000000000000000000000YYYYYYYYYYY"+Y_Position.toString());
                  // print("11111111111111111111111111111111111111111&XXXXXXXXXXXX"+X_Position.toString());
                  //  print (state.size);
                  //  print( MediaQuery. of(context). size. width);
                  // print( MediaQuery. of(context). size. height);


                  if (dx >= X_Position && dx < (X_Position + 100) &&
                      dy >= Y_Position && dy < (Y_Position + 100)) {
                    isIN = true;
                    inOrOut.add(true);
                  }
          ...
          Column(
            children: [
              Text("$isIN",style: TextStyle(fontSize: 60),),

              SizedBox(height: 50,),
              Text(percentage,style: TextStyle(fontSize: 60),),
